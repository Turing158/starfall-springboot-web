...
//注册发送邮箱内容
    public void reg_mail(String mail,String num) throws EmailException, MessagingException {
...
//    修改密码发送邮箱内容
    public void set_mail(String mail,String num) throws EmailException, MessagingException {
