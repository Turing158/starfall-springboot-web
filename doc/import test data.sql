...
配置tomcat，方可运行
', null, null, null, null);
INSERT INTO web.topic (id, icon, label, title, user, date, comment, view, href, label_href, titlename, titleenglishname, source, version, language, address, download, content, authorname, username, userhead, userinformation) VALUES (3, 'bedwars.png', '服务端', '[1.8.x][Spigot]星辰倾城-起床战争服务端', 'Turing_ICE', '2023-07-02', 3, 100, '/topic/html?html=3', 'serve', '星辰倾城-起床战争服务端', 'StarFall-BedWard', '原创', '1.8.x', '简体中文', 'https://www.mcbbs.net/thread-773917-1-1.html', 'http://www.本贴.com', '# 星辰倾城-起床战争服务端
...
配置tomcat，方可运行
', null, null, null, null);
INSERT INTO web.topic (id, icon, label, title, user, date, comment, view, href, label_href, titlename, titleenglishname, source, version, language, address, download, content, authorname, username, userhead, userinformation) VALUES (4, 'TheUndeadWar.jpg', '视频', '[冰骐解说]我的世界|亡灵战争', 'Turing_ICE', '2023-07-20', 6, 100, '/topic/html?html=4', 'video', '我的世界|亡灵战争', 'Minecraft|War of the Undead', '原创', '1.6', '简体中文', 'https://www.mcbbs.net/thread-878770-1-1.html', 'https://www.mcbbs.net/thread-878770-1-1.html', null, null, null, null, null);
INSERT INTO web.topic (id, icon, label, title, user, date, comment, view, href, label_href, titlename, titleenglishname, source, version, language, address, download, content, authorname, username, userhead, userinformation) VALUES (5, 'Double.png', '视频', '[冰骐]Minecraft双人默契大挑战——两位初三的帅[dou]气[bi]解密', 'Turing_ICE', '2023-06-14', 6, 100, '/topic/html?html=5', 'video', '双人默契大挑战', 'The Great Challenge of Mutual Understanding', '原创', '无', '简体中文', 'https://www.mcbbs.net/thread-812503-1-1.html', 'https://www.mcbbs.net/thread-812503-1-1.html', null, null, null, null, null);
INSERT INTO web.topic (id, icon, label, title, user, date, comment, view, href, label_href, titlename, titleenglishname, source, version, language, address, download, content, authorname, username, userhead, userinformation) VALUES (7, 'healthPlug_in.png', '插件', '[信息]BeautyIndicator——轻量级的显血插件[1.8-1.12] [接权搬运]', 'Turing_ICE', '2023-07-11', 3, 100, '/topic/html?html=7', 'plug_in', '轻量级的显血', 'BeautyIndicator', '搬运', '1.8-1.12', '简体中文|English', 'https://www.spigotmc.org/resources/beautyindicator-entity-health-in-combat.57546/', 'https://www.spigotmc.org/resources/beautyindicator-entity-health-in-combat.57546/download?version=225018/SupportTheAuthor', null, null, null, null, null);
INSERT INTO web.topic (id, icon, label, title, user, date, comment, view, href, label_href, titlename, titleenglishname, source, version, language, address, download, content, authorname, username, userhead, userinformation) VALUES (8, 'imgPlug_in.png', '插件', '[娱乐|信息][StarMC]Powder——通过粒子来显示图像！[1.12][接权搬运]', 'Turing_ICE', '2023-07-06', 1, 100, '/topic/html?html=8', 'plug_in', '粒子图像', 'Powder', '搬运', '1.12', '简体中文|English', 'https://www.spigotmc.org/resources/powder.57227/', 'https://www.spigotmc.org/resources/powder.57227/download?version=224643', null, null, null, null, null);
INSERT INTO web.topic (id, icon, label, title, user, date, comment, view, href, label_href, titlename, titleenglishname, source, version, language, address, download, content, authorname, username, userhead, userinformation) VALUES (9, 'SkillAPIArticle.png', '文章', 'SkillAPI教程and案例——来自定义职业吧！', 'Turing_ICE', '2023-07-08', 8, 100, '/topic/html?html=9', 'article', 'SkillAPI教程and案例——来自定义职业吧！', 'SkillAPI Tutorial and Case Study - Customize Your Career!', '原创', '无', '简体中文', 'https://www.mcbbs.net/thread-809466-1-1.html', 'https://www.mcbbs.net/thread-809466-1-1.html', null, null, null, null, null);
...
INSERT INTO web.topic (id, icon, label, title, user, date, comment, view, href, label_href, titlename, titleenglishname, source, version, language, address, download, content, authorname, username, userhead, userinformation) VALUES (11, 'MaintenancePlug_in.jpg', '插件', '[管理|信息][StarMC]MaintenanceMode-维护模式[接权搬运][1.8-1.12]', 'Turing_ICE', '2023-07-06', 4, 100, '/topic/html?html=11', 'plug_in', '维护模式', 'MaintenanceMode', '搬运', '1.8-1.12', '简体中文|English', 'https://www.spigotmc.org/resources/maintenancemode-bungee-and-spigot-support.40699/', 'https://www.spigotmc.org/resources/maintenancemode-bungee-and-spigot-support.40699/download?version=217708', null, null, null, null, null);
INSERT INTO web.topic (id, icon, label, title, user, date, comment, view, href, label_href, titlename, titleenglishname, source, version, language, address, download, content, authorname, username, userhead, userinformation) VALUES (12, 'LanguageBarrierBreakerPlug_in.jpg', '插件', '[信息]Language Barrier Breaker-多种语言[接权搬运][1.8-1.12] ', 'Turing_ICE', '2023-07-05', 2, 100, '/topic/html?html=12', 'plug_in', '多种语言', 'Language Barrier Breaker', '搬运', '1.8-1.12', '简体中文|English', 'https://www.spigotmc.org/resources/rosetta-stone-language-barrier-breaker.55570/', 'https://www.spigotmc.org/resources/rosetta-stone-language-barrier-breaker.55570/download?version=217291', null, null, null, null, null);
