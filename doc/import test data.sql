...
配置tomcat，方可运行
', null, null, null, null);
INSERT INTO web.topic (id, icon, label, title, user, date, comment, view, label_href, titlename, titleenglishname, source, version, language, address, download, content, authorname, username, userhead, userinformation) VALUES (2, 'package.jpg', '客户端', '[1.12.2-1.8][低配福利]骐的整合---纯净基础整合[持续更新]', 'Turing_ICE', '2023-07-04', 8, 100, 'Client', '骐的整合', 'Integration of Qi', '原创', '1.12.2-1.8', '简体中文', 'https://www.mcbbs.net/thread-1126142-1-1.html', 'https://www.mcbbs.net/thread-1126142-1-1.html', '# 骐的整合
...
配置tomcat，方可运行
', null, null, null, null);
INSERT INTO web.topic (id, icon, label, title, user, date, comment, view, label_href, titlename, titleenglishname, source, version, language, address, download, content, authorname, username, userhead, userinformation) VALUES (3, 'bedwars.png', '服务端', '[1.8.x][Spigot]星辰倾城-起床战争服务端', 'Turing_ICE', '2023-07-02', 3, 100, 'serve', '星辰倾城-起床战争服务端', 'StarFall-BedWard', '原创', '1.8.x', '简体中文', 'https://www.mcbbs.net/thread-773917-1-1.html', 'http://www.本贴.com', '# 星辰倾城-起床战争服务端
...
INSERT INTO web.good (id, good, user, topicid, date) VALUES (5, 1, 'admin', 4, '2023-08-29');
